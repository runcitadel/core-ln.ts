import ApiClient, { transform, transformMap } from "https://deno.land/x/core_ln_base@v0.2.0-deno.1";
import { createConnection, type Socket } from "https://deno.land/std@0.146.0/node/net.ts";
