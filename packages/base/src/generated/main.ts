...
import type { Node, ListnodesResponse } from "./listnodes";
...
} from "./emergencyrecover";
import type { MakesecretRequest, MakesecretResponse } from "./makesecret";
import type {
  RecoverchannelRequest,
  RecoverchannelResponse,
} from "./recoverchannel";
import type { SignpsbtRequest, SignpsbtResponse } from "./signpsbt";
import type { StaticbackupRequest, StaticbackupResponse } from "./staticbackup";
...
export default abstract class RPCClient extends EventEmitter {
   ...
   */
  autocleaninvoice(
    payload: AutocleaninvoiceRequest = {}
  ): Promise<AutocleaninvoiceResponse> {
   ...
   */
  delexpiredinvoice(
    payload: DelexpiredinvoiceRequest = {}
  ): Promise<DelexpiredinvoiceResponse> {
   ...
   */
  fundchannelCancel(
    payload: FundchannelCancelRequest
  ): Promise<FundchannelCancelResponse> {
   ...
   */
  fundchannelComplete(
    payload: FundchannelCompleteRequest
  ): Promise<FundchannelCompleteResponse> {
    return this.call<FundchannelCompleteResponse>(
   ...
   */
  fundchannelStart(
    payload: FundchannelStartRequest
  ): Promise<FundchannelStartResponse> {
   ...
   */
  funderupdate(
    payload: FunderupdateRequest = {}
  ): Promise<FunderupdateResponse> {
   ...
   */
  listdatastore(
    payload: ListdatastoreRequest = {}
  ): Promise<ListdatastoreResponse> {
   ...
   */
  listsendpays(
    payload: ListsendpaysRequest = {}
  ): Promise<ListsendpaysResponse> {
   ...
   */
  multifundchannel(
    payload: MultifundchannelRequest
  ): Promise<MultifundchannelResponse> {
   ...
   */
  openchannelAbort(
    payload: OpenchannelAbortRequest
  ): Promise<OpenchannelAbortResponse> {
   ...
   */
  openchannelBump(
    payload: OpenchannelBumpRequest
  ): Promise<OpenchannelBumpResponse> {
   ...
   */
  openchannelInit(
    payload: OpenchannelInitRequest
  ): Promise<OpenchannelInitResponse> {
   ...
   */
  openchannelSigned(
    payload: OpenchannelSignedRequest
  ): Promise<OpenchannelSignedResponse> {
   ...
   */
  openchannelUpdate(
    payload: OpenchannelUpdateRequest
  ): Promise<OpenchannelUpdateResponse> {
   ...
   */
  sendonionmessage(
    payload: SendonionmessageRequest
   ...
   */
  unreserveinputs(
    payload: UnreserveinputsRequest
  ): Promise<UnreserveinputsResponse> {
   ...
   */
  waitblockheight(
    payload: WaitblockheightRequest
  ): Promise<WaitblockheightResponse> {
...
export { type AddgossipRequest, type AddgossipResponse } from "./addgossip";
export {
  type AutocleaninvoiceRequest,
  type AutocleaninvoiceResponse,
} from "./autocleaninvoice";
export { type CheckRequest, type CheckResponse } from "./check";
export {
...
export { type DatastoreRequest, type DatastoreResponse } from "./datastore";
export {
  type DecodeRequest,
  type DecodeResponse,
} from "./decode";
...
export { type DisconnectRequest, type DisconnectResponse } from "./disconnect";
export {
...
export { type InvoiceRequest, type InvoiceResponse } from "./invoice";
export {
  type KeysendRequest,
...
export { type OfferRequest, type OfferResponse } from "./offer";
export { type OfferoutRequest, type OfferoutResponse } from "./offerout";
export {
...
export { type PayRequest, type PayResponse, Status as PayStatus } from "./pay";
export { type PingRequest, type PingResponse } from "./ping";
export {
  type PluginRequest,
  type PluginResponse,
...
export { type SendpsbtRequest, type SendpsbtResponse } from "./sendpsbt";
export {
...
export { type SignpsbtRequest, type SignpsbtResponse } from "./signpsbt";
export { type StopRequest, type StopResponse } from "./stop";
export { type TxdiscardRequest, type TxdiscardResponse } from "./txdiscard";
export { type TxprepareRequest, type TxprepareResponse } from "./txprepare";
export { type TxsendRequest, type TxsendResponse } from "./txsend";
export {
...
export { type WithdrawRequest, type WithdrawResponse } from "./withdraw";
