...
export { DatastoreResponse as RestDataStoreResponse, DatastoreRequestBody } from "./generated/Datastore";
export {
...
export { WithdrawResponse as RestWithdrawResponse, WithdrawRequestBody } from "./generated/Withdraw";
export {
    OffersOfferResponse,
...
export { PayResponse as RestPayResponse, PayRequestBody } from "./generated/Pay";
export {
    PayListPaysResponse,
...
export { PayKeysendResponse, PayKeysendRequestBody } from "./generated/PayKeysend";
export {
    PeerConnectResponse,
